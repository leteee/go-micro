...
func (c *greetClient) SayHello(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloRes, error) {
	out := new(HelloRes)
...
func (UnimplementedGreetServer) SayHello(context.Context, *HelloReq) (*HelloRes, error) {
